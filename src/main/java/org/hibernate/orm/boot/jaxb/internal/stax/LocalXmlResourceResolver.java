...
public class LocalXmlResourceResolver implements javax.xml.stream.XMLResolver {
	...
	private final ClassLoaderService resourceLocator;

	public LocalXmlResourceResolver(ClassLoaderService resourceLocator) {
	...
	public static class NamespaceSchemaMapping {
		...
		public NamespaceSchemaMapping(String namespace, String resourceName) {
			...
			this.localSchemaUrl = org.hibernate.boot.jaxb.internal.stax.LocalSchemaLocator.resolveLocalSchemaUrl( resourceName );
		}
